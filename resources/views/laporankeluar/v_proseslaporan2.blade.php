...
<section class="content">
    <div class="container-fluid">
        <div class="card card-default">
            ...
            <form action="/laporankeluar/insertv" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-widget">
                                ...
                                <div class="card-body">
                                    <span class="description">Produk dari: <i style="color: blue;">{{$produk->variasi_produk}}</i></span><br>
                                    <img class="img-fluid pad" src="{{url('foto_produk/'. $produk->foto_produk)}}" alt="Photo" width="300" loading="lazy"><br>
                                    <span class="description">Tersedia: <u>{{$produk->variasi_stok_produk}}</u>pcs</span>
                                </div>
                            </div>
                        </div>
                        <!-- /.col -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kodeproduk_keluar" value="{{$produk->kodeproduk_variasi}}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="jlhproduk_laporan" value="1" min="1" max="{{$produk->variasi_stok_produk}}">
                            </div>
                            <div class="form-group">
