...
@section('title','Lapor Produk Masuk')
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <a href="/laporanmasuk/tambah/{{$data->id_produk}}" class="btn btn-sm btn-warning">Tambah Stok <i class="fas fa-plus-square"></i></a>
                        <div class="col-md-12 mt-3">
                            <div class="card card-primary collapsed-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/laporanmasuk/tambahv/{{$data->id_produk}}" class="btn btn-success btn-sm">Tambah Stok <i class="fas fa-plus-square"></i></a>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            <!-- /.card -->
